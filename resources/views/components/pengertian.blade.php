<section class="flex flex-col justify-center items-center px-15 z-40 mt-5" id="dedikasi">
    ...
    <div class="grid grid-cols-1 place-items-center md:flex gap-5 justify-center items-center">
        <img class="h-45 hover:-translate-y-0.5 hover:shadow-xl duration-150 rounded-md" src="/hero/minihero1.png"
            alt="foto dedikasi">
        <div class="flex flex-col gap-2 justify-center items-center md:justify-start md:items-start">
            <h2 class="text-md md:text-lg font-bold text-[#E9C153]">DEDIKASI MALANG</h2>

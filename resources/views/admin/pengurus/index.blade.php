...
@section('title', 'Manajemen Kepengurusan - Dedikasi Malang')
@section('header')
...
@section('content')
    ...
    <div>
        <div id="pengurusCardContainer">
            @include('admin.pengurus._card', ['pengurus' => $pengurus])
        </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const cardContainer = document.getElementById('pengurusCardContainer');
            const paginationContainer = document.getElementById('pagination-container');
            const searchUrl = "{{ route('admin.pengurus.search') }}";
            const originalUrl = "{{ route('admin.pengurus.index') }}";
            ...
            function performSearch(query) {
                ...
                fetch(`${searchUrl}?search=${encodeURIComponent(query)}`)
                    ...
                    .catch(error => {
                        ...
                        cardContainer.innerHTML = `<div class="p-6 text-center text-red-500">Gagal memuat data. Silakan coba lagi.</div>`;
                    });
            }

@forelse ($kegiatan as $item)
    <tr>
        ...
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" title="{{ $item->lokasi }}">
        ...
        <td colspan="7" class="px-6 py-10 text-center">
            ...
            <div class="flex flex-col items-center justify-center space-y-4">
                ...
                <p class="text-sm text-gray-500 max-w-sm">
                    Tambahkan kegiatan baru untuk mulai mengisi tabel ini. Semua data kegiatan yang Anda buat akan muncul di
                    sini.
                </p>
            </div>

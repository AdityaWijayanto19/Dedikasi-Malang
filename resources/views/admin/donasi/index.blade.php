...
@section('title', 'Manajemen Donasi - Dedikasi Malang')
@section('header')
...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow-md overflow-x-hidden">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody id="donasiTableBody" class="bg-white divide-y divide-gray-200">
                @include('admin.donasi._table_rows', ['donasi' => $donasi])
            </tbody>
        </table>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const searchUrl = "{{ route('admin.donasi.search') }}";
            const originalUrl = "{{ route('admin.donasi.index') }}"; 
            let debounceTimer;
